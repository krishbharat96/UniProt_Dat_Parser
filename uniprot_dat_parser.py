        ...
        for line in isostring.splitlines():
            ...
            if "IsoId=" in line:
                ...
                for info in info_arr:
                    ...
                    if "Sequence=" in info:
                        seq_type = info.replace("Sequence=", "").strip()
...
def process_protein(prot_string):
    ...
    prot_dict.update({id_prot:{"Name":prot_name, "Description":process_de(de_arr), "Isoform":create_iso(isostring), "SV":sv_int, "PE":pe_val, "Gene":gene_arr, "Database":db_name}})
    # print prot_dict[id_prot]
